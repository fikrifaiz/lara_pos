  ...
  <div class="col-md-4 col-md-offset-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo e(route('seller.update',$seller)); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="Enter Your Name" value="<?=$seller->name?>">
          </div>
          <div class="form-group">
